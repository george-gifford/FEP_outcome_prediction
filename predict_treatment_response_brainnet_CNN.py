...
# -*- coding: utf-8 -*-
"""
Created on Thu May 28 11:34:36 2020
...
results_file = open(results_dir + 'predict_treatment_response_results_brainnet_CNN_' + data_type + '_' + network_size + '_' + site_correction + '_' + date_string + '.txt', "w")
