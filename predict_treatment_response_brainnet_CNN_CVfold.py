...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun  8 12:33:03 2020
...
for i in range(n_repeats) :
    ...
    # fit and predict
    model.fit(train_matrices, train_targets ,epochs=500, batch_size=20, verbose=1)
...
# save results DF
subjects_response_results.to_csv(results_dir + 'predict_treatment_response_results_brainnet_CNN_MSE_' + data_type + '_' + network_size + '_' + site_correction + '_CV_fold_' + job_id + '.csv')