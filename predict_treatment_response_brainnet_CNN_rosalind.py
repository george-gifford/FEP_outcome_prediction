...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  2 10:47:57 2020
...
# import what we need
import sys
sys.path.append("/users/k1511004/projects/neuroCombat/neuroCombat/") 
sys.path.append("/users/k1511004/projects/anatomical_covariance/") 
sys.path.append("/users/k1511004/projects/riem_mglm/")
sys.path.append("/users/k1511004/projects/BrainNetCNN_keras/")
...
# set directories 
sMRI_data_dir = '/scratch/users/k1511004/data/PSYSCAN/FEP/sMRI/FS_data/'
fMRI_data_dir = '/scratch/users/k1511004/data/PSYSCAN/FEP/fMRI/'
FS_data_dir = sMRI_data_dir
metadata_dir = '/scratch/users/k1511004/data/PSYSCAN/FEP/metadata/demographic_metadata/'
outcomes_dir = '/scratch/users/k1511004/data/PSYSCAN/FEP/metadata/outcomes_metadata/'
results_dir = '/scratch/users/k1511004/data/PSYSCAN/FEP/results/'
...
if data_type == 'fMRI' or data_type == 'sMRI_fMRI_subjects' :
    ...
    data = outcomes_metadata_data.iloc[:, 16:].values
...
results_file = open(results_dir + 'predict_treatment_response_results_brainnet_CNN_' + data_type + '_'+ date_string + '.txt', "w") 
