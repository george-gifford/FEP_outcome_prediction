...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 11 11:35:59 2020
...
# save results DF
subjects_response_results.to_csv(results_dir + 'predict_treatment_response_results_brainnet_CNN_multichannel_' + network_size + '_' + site_correction + '_CV_fold_' + job_id + '.csv')